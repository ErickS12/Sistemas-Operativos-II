...
public class ControlPanel extends Frame {
  ...
  // Nuevo
  private JTextArea areaSegmentos;
  private JTextArea areaAging;
  ...
  public void actualizarSegmentos(String texto) {
        areaSegmentos.setText(texto);
  }

  public void actualizarAging(String texto) {
    areaAging.setText(texto);
}
  ...
  public void init(Kernel useKernel, String commands, String config) {
    ...
    areaSegmentos = new JTextArea();
    areaSegmentos.setEditable(false);

    JScrollPane scrollSegmentos = new JScrollPane(areaSegmentos);
    scrollSegmentos.reshape(285, 280, 320, 100);
    add(scrollSegmentos);

    areaAging = new JTextArea();
    areaAging.setEditable(false);

    JScrollPane scrollAging = new JScrollPane(areaAging);
    scrollAging.reshape(285, 380, 320, 120);  // Ajusta si quieres
    add(scrollAging);
